...
class BarcodeGenerator:
    ...
    def generate_preview(self, data: LabelData) -> Optional[Image.Image]:
        ...
        try:
            ...
            preview_width = int(self.settings.LABEL_WIDTH * 0.5)  # 50% of original size
            preview_height = int(self.settings.LABEL_HEIGHT * 0.5)
            
            # Use high-quality downsampling
            preview = label.resize(
