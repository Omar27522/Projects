...
def create_settings_dialog_handler(parent, config_manager, update_label_count_callback):
    ...
    Returns:
        None
    """
    # Define the save settings callback
    ...
    # Define the open sheets dialog callback
    def open_sheets_dialog(config_manager):
        ...
        # Update the config_manager with the new settings
        # Since we can't use nonlocal, we'll update the parent's config_manager directly
        parent.config_manager = new_config_manager
    
    # Create settings dialog using the utility function
    settings_dialog, directory_var, label_count_var = create_settings_dialog(
        parent,
        config_manager,
        update_label_count_callback,
        lambda: open_sheets_dialog(config_manager),
        save_settings
    )
    
    # Store the label count variable for updating
    parent.label_count_var = label_count_var
