...
class GoogleSheetsDialog(tk.Toplevel):
    ...
    def __init__(self, parent, config_manager=None, update_callback=None):
        ...
        # Initialize config manager and callback
        self.config_manager = config_manager if config_manager else ConfigManager()
        self.update_callback = update_callback
        
        # Initialize connection status from saved settings
        if (hasattr(self.config_manager.settings, 'google_sheets_connection_status') and 
            self.config_manager.settings.google_sheets_connection_status):
            self.connection_status = self.config_manager.settings.google_sheets_connection_status
        else:
    ...
    def _create_ui(self):
        ...
        # Fetch Sheets Button has been removed
        ...
        test_button = tk.Button(
            ...
            padx=20,
            pady=10,
            width=15  # Slightly wider for the longer text
        )
        test_button.pack(side='left', padx=(10, 5))
        ...
        save_button = tk.Button(
            ...
            bg='#4CAF50',
            fg='white',
            activebackground='#6abe6e',
            activeforeground='white',
            font=("Arial", 10, "bold"),
            relief='flat',
            padx=25,
            pady=10,
            width=12  # Set explicit width to match Cancel button
        )
        save_button.pack(side='right', padx=(15, 10))
        
        # Cancel button removed - users can close the window using the X button
    ...
    def _test_connection(self):
        ...
        try:
            ...
            if success:
                ...
                # Store connection status in config manager
    ...
    def _save_settings(self):
        ...
        try:
            ...
            # Save settings using ConfigManager's save_settings method
