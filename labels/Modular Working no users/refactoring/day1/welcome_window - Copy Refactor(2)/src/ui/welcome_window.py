...
import pyautogui
import time
from src.utils.file_utils import ensure_directory_exists, count_files_in_directory, get_central_log_file_path, log_shipping_record, directory_exists, file_exists, get_project_root, find_files_by_sku, get_credentials_file_path
...
class WelcomeWindow(tk.Tk):
    ...
    def management_action(self):
        ...
        try:
            ...
            temp_script_path = os.path.join(project_root, 'temp_view_files.py')
...
''')
            ...
            temp_script_path = os.path.join(get_project_root(), 'temp_view_files.py')
            if file_exists(temp_script_path):
                try:
                    os.remove(temp_script_path)
                except:
