    ...
    try:
        ...
        if mirror_print:
            try:
                ...
                # Use a more efficient temp directory path
                ...
                # Verify mirrored file was created
        ...
        # Use a more direct approach to printing to reduce delay
        # The "print" verb in startfile triggers the print dialog
        print(f"Sending {print_path} to printer...")
        
        # Update status before printing to provide immediate feedback
        if status_callback:
            status_callback("Sending label to printer...", 'blue')
            
        # Use startfile with the "print" verb to open the print dialog
...
def find_or_create_barcode(tracking_number, sku, directory, mirror_print=False, status_callback=None):
    ...
    if status_callback:
        status_callback("Label creation has been disabled by administrator", 'orange')
    return False, None, False, "Label creation has been disabled by administrator"
