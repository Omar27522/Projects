...
class MainWindow(tk.Tk):
    ...
    def view_directory_files(self):
        ...
        # Add mirror print toggle button with last print time
        ...
        # Add last print time label
        last_print_label = tk.Label(top_frame, text="", font=('TkDefaultFont', 9), fg='#666666')
        last_print_label.pack(side=tk.RIGHT, padx=(0, 10))
        ...
        def update_last_print_time():
            ...
            if self.last_print_time:
                ...
                last_print_label.bind('<Button-1>', lambda e: insert_last_upc())
            else:
        ...
        search_entry.bind("<Control-z>", lambda e: search_entry.edit_undo() if search_entry.edit_undo() else None)
        search_entry.bind("<Control-y>", lambda e: search_entry.edit_redo() if search_entry.edit_redo() else None)
        ...
        def update_file_list(*args):
            ...
            try:
                ...
                if len(matched_files) == 0:
                    ...
                    listbox.selection_clear(0, tk.END)
                    listbox.select_set(0)  # Select the "No matching files found" text in the listbox
                    listbox.see(0)
