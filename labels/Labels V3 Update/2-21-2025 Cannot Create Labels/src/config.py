...
class LabelSettings:
    ...
    files_window_on_top: bool = False
            ...
            if os.path.exists(self.settings_file):
                with open(self.settings_file, 'r') as f:
                    ...
                    self.settings = LabelSettings(
                        ...
                        files_window_on_top=data.get('files_window_on_top', False),
                        auto_minimize=data.get('auto_minimize', True)
                    )
    ...
    def save_settings(self) -> None:
        ...
        try:
            settings_dict = {
                ...
                'files_window_on_top': self.settings.files_window_on_top,
                'auto_minimize': self.settings.auto_minimize
            }
